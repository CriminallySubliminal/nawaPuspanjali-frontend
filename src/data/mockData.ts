...
export const mockSizes: Size[] = [
    { id: 1, name: 'School Size (18x24 cm)', slug: 'school-size', display_order: 1 },
    { id: 2, name: 'Big Size (19x27 cm)', slug: 'big-size', display_order: 2 },
    { id: 3, name: 'A4 Size (21x29.7 cm)', slug: 'a4-size', display_order: 3 },
    { id: 4, name: 'Pocket Size', slug: 'pocket-size', display_order: 4 },
];
...
const puspanjaliCopyVariants: NotebookVariant[] = [
    {
        ...
        no_of_pages: 120,
        price_per_dozen: '480.00',
        price_per_unit: '40.00',
        display_name: 'Puspanjali Copy (Big Size, Single Lined, 120 Pages)',
        is_active: true,
        created_at: now,
        updated_at: now,
    ...
    },
    {
        ...
        price_per_dozen: '480.00',
        price_per_unit: '40.00',
        display_name: 'Puspanjali Copy (Big Size, 2 Lined, 120 Pages)',
        is_active: true,
        created_at: now,
        updated_at: now,
...
const puspanjaliRegisterVariants: NotebookVariant[] = [
    {
        ...
        ruling: mockRulings[0],
        no_of_pages: 240,
        price_per_dozen: '1200.00',
        price_per_unit: '100.00',
        display_name: 'Puspanjali Register (A4, Single Lined, 240 Pages)',
        is_active: true,
        created_at: now,
        updated_at: now,
...
const ecoWriteSpiralVariants: NotebookVariant[] = [
    {
        ...
        no_of_pages: 100,
        price_per_dozen: '600.00',
        price_per_unit: '50.00',
        display_name: 'Eco-Write Spiral (A4, Unruled, 100 Pages)',
        is_active: true,
        created_at: now,
        updated_at: now,
