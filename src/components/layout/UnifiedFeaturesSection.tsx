        ...
        <section className="bg-transparent relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 w-full">
                <motion.div
                    ...
                    className="mb-10 md:mb-16 text-center max-w-4xl mx-auto"
                >
                    {/* <span className="text-brand-deep font-bold tracking-wider uppercase text-sm mb-4 inline-block">
                        Why Puspanjali
                    </span> */}
                    <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-charcoal leading-tight mb-6">
                        Quality You Can <br />
                ...
                >
                    ...
                    <GlowingCard glowColor="#f59e0b" className="bg-ivory dark:bg-zinc-900 border-charcoal/5 shadow-subtle hover:shadow-medium">
                        ...
                        >
                            <svg className="w-5 h-5 md:w-7 md:h-7 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                            </svg>
                        </div>
                        <h3 className="text-base md:text-xl font-semibold text-charcoal dark:text-white mb-1 md:mb-3">
                            Quality Assured
                        </h3>
                        <p className="text-graphite dark:text-zinc-400 leading-relaxed text-xs md:text-sm">
                    ...
                    <GlowingCard glowColor="#0d9488" className="bg-ivory dark:bg-zinc-900 border-charcoal/5 shadow-subtle hover:shadow-medium">
                        ...
                        >
                            <svg className="w-5 h-5 md:w-7 md:h-7 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <GlowingCard
                        glowColor="#ffffff"
                        className="hidden md:block col-span-2 md:row-span-2 bg-teal-600 rounded-[2rem] p-6 sm:p-8 md:p-14 relative overflow-hidden group border-none"
                    >
                        <div className="relative z-10 h-full flex flex-col justify-between">
                            ...
                            <div>
                                <h3 className="text-xl md:text-3xl font-bold text-white mb-2 md:mb-4">Eco-Conscious Sourcing</h3>
                    ...
                    <GlowingCard
                        glowColor="#2dd4bf"
                        className="hidden md:flex md:row-span-2 bg-brand-light h-full rounded-[2rem] p-6 sm:p-8 md:p-10 flex-col relative overflow-hidden group border-none"
                    >
                        ...
                        <div className="mt-4 md:mt-8">
                            <h3 className="text-lg md:text-2xl font-bold text-charcoal mb-1 md:mb-2">100% Recyclable</h3>
                            <p className="text-charcoal-light/70 uppercase text-xs font-bold tracking-widest mb-2 md:mb-4">Sustainability First</p>
                    ...
                    <GlowingCard
                        glowColor="#27272a"
                        className="hidden md:flex col-span-2 bg-charcoal rounded-[2rem] p-6 sm:p-8 md:p-12 flex-col md:flex-row items-center gap-4 md:gap-8 relative overflow-hidden group border-none"
                    >
                        ...
                        <div className="relative z-10 flex-1">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-lg md:text-2xl font-bold text-white">Premium Finish</h3>
                            </div>
                    ...
                    <GlowingCard
                        glowColor="#fbbf24"
                        className="hidden md:block bg-ivory rounded-[2rem] p-6 sm:p-8 md:p-10 relative overflow-hidden group border-none"
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-lg md:text-2xl font-bold text-charcoal mb-1 md:mb-2">Whiter & Brighter</h3>
                            <p className="text-charcoal/80 text-sm md:text-base">
