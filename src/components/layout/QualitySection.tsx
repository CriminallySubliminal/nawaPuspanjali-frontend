            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 auto-rows-[minmax(200px,auto)]">
                    ...
                    <motion.div
                        ...
                        className="md:col-span-2 row-span-2 bg-teal-600 rounded-[2rem] p-10 md:p-14 relative overflow-hidden group"
                    >
                    ...
                    <motion.div
                        ...
                        className="md:row-span-2 bg-brand-light h-full rounded-[2rem] p-10 flex flex-col relative overflow-hidden group"
                    >
                    ...
                    <motion.div
                        ...
                        className="md:col-span-2 bg-charcoal rounded-[2rem] p-10 md:p-12 flex flex-col md:flex-row items-center gap-8 relative overflow-hidden group"
                    >
                    ...
                    <motion.div
                        ...
                        className="bg-brand-lightest rounded-[2rem] p-10 relative overflow-hidden group"
                    >
